...
public class MainSceneController : MonoBehaviour
{
    ...
    private string HomeSceneName = "dropQuiz";
    ...
    public void HandleSceneButtonClick(int sceneEnum)
    {
        ...
        // set screen sharing canvas active instead
        //if (screenSharingCanvas != null && !screenSharingCanvas.activeSelf)
        //{
